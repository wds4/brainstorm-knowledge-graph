...
const Curation = React.lazy(() => import('src/views/simpleLists/list/curation/index'))
const ViewCuration = React.lazy(() => import('src/views/simpleLists/list/curation/viewCuration/index'))
const EditCuration = React.lazy(() => import('src/views/simpleLists/list/curation/editCuration/index'))
const ExportTL = React.lazy(() => import('src/views/simpleLists/list/curation/exportTrustedList/index'))
const ViewTL = React.lazy(() => import('src/views/simpleLists/list/curation/viewTrustedLists/index'))
...
const routes = [
  ...
  { path: '/simpleLists/list/curation/exportTrustedList', name: 'Export Trusted List', element: ExportTL },
  { path: '/simpleLists/list/curation/viewTrustedLists', name: 'View Trusted Lists', element: ViewTL },
]
