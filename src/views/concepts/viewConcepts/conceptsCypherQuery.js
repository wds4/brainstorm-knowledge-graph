...
const ConceptsCypherQuery = () => {
  ...
  queryOptions[1] =
    'MATCH n = (listHeader)-[:IS_THE_CONCEPT_FOR]->(superset:Superset)-[:IS_A_SUPERSET_OF *0..5]->(subset)-[:HAS_ELEMENT]->(element) RETURN n, listHeader, superset, subset, element LIMIT 5'
  ...
  const defaultQuery = queryOptions[1]
...
export default ConceptsCypherQuery
